...
SRC_URI="${SRC_BASE}/${MY_P_SRC}-dist-${PN}.tar.gz
	java? ( ${SRC_BASE}/${MY_P_SRC}-dist-java.tar.gz )
	doc? (
		${SRC_BASE}/${MY_DP}_documentation/${MY_DP}3crm.pdf
		${SRC_BASE}/${MY_DP}_documentation/${MY_DP}3frm.pdf
		${SRC_BASE}/${MY_DP}_documentation/${MY_DP}ifd.pdf
		${SRC_BASE}/${MY_DP}_documentation/${MY_DP}3prm.pdf
		${SRC_BASE}/${MY_DP}_documentation/${MY_DP}3ug.pdf
		java? ( ${SRC_BASE}/${MY_DP}_documentation/${MY_DP}3jrm.pdf )
	)"
