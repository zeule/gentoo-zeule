...
SRC_URI="http://www.linux-onlineshop.de/forum/index.php?page=Attachment&attachmentID=424&h=3df4c21145314ceaeadd7986662b2a5b01d1094f&s=0583cdbfa8839e5c35ee6ed5f4574a6a6d1ac37b -> ${PN}-${PV}.src.tar.gz"
...
src_prepare() {
	sed -i -e 's/$(shell uname -r)/'${KV_FULL}'/' src/Makefile || die "sed failed"
}
