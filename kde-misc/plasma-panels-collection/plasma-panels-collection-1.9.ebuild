...
DESCRIPTION="Templates for Plasma panels"

# Homepage, not used by Portage directly but handy for developer reference
HOMEPAGE="http://opendesktop.org/content/show.php?content=147589"

# Point to any required sources; these will be automatically downloaded by
# Portage.
SRC_URI="http://kde-peace-settings.googlecode.com/files/Plama-Panels-Collection_${PV}.tar.gz"
...
RDEPEND="${DEPEND}
	>=kde-base/plasma-workspace-4.8"

# Source directory; the dir where the sources can be found (automatically
# unpacked) inside ${WORKDIR}.  The default value for S is ${WORKDIR}/${P}
# If you don't need to change it, leave the S= line out of the ebuild
# to keep it tidy.
S=${WORKDIR}/Plama-Panels-Collection
